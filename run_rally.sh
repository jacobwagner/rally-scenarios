-#!/bin/bash
 ...
 -rally -vd task start scenarios/{{RALLY_PRIME_TASK}} {{RALLY_PRIME_PARMS}} > prime-rally-console.out 2>&1
 ...
 -rally -vd task start scenarios/{{RALLY_TASK}} {{RALLY_PARMS}} > rally-console.out 2>&1
